...
const Content3 = () => {
  return (
    <div className="text-white bg-hero-pepper p-1  lg:p-44 bg-cover bg-center  ">
      ...
      >
        <span className="absolute top-0 right-0 inline-block w-4 h-4 transition-all duration-500 ease-in-out bg-orange-400 rounded group-hover:-mr-4 group-hover:-mt-4">
