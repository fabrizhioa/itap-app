  ...
  return (
    <footer className="text-gray-600 body-font  bg-neutral-200">
      <div className="border-t border-gray-200 bg-neutral-800">
        ...
        <label for="email" class="leading-7 text-2xl text-gray-300">Subscribete!</label>
        <input type="email" id="email" name="email" class="w-72 bg-gray-100 bg-opacity-50  border-yellow-300 focus:border-red-500 focus:bg-transparent focus:ring-2 focus:ring-yellow-700 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"/>
          <div className="flex md:flex-nowrap flex-wrap justify-center items-end md:justify-center">
          <button class="text-white bg-yellow-600 py-2 px-8 focus:outline-none hover:bg-gray-600  text-lg">Button</button>
          </div>
        </div>
