  ...
  return (
    <section className="text-white bg-hero-max  bg-cover bg-center  ">
      <div class="max-w-full mx-auto py-1 lg:py-10 lg:px-32  ">
        ...
        <div className="px-1 mt-2 lg:px-36 lg:justify-start justify-end lg:mt-6 flex">
          <button href="#_" class="relative px-0 lg:px-4 lg:py-4 py-1 font-medium text-white group">
