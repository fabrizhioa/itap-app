...
const Content = () => {
  return (
    <section className="text-white bg-hero-max  bg-cover bg-center  ">
      <div class="max-w-6xl mx-auto py-1 lg:py-10 lg:px-14  ">
        <p class="mt-2 text-4xl font-semibold text-start px-4 lg:px-20   text-gray-50  sm:tracking-tight lg:text-6xl">
          Una Nueva
        </p>
        <p class="mt-2 text-4xl font-semibold text-start px-4  lg:px-20   text-gray-50  sm:tracking-tight lg:text-6xl">
          Manera De
        ...
        <div className="px-5 mt-5 lg:px-36  lg:mt-6 flex">
