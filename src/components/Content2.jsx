...
const Content2 = () => {
  return (
    <section className="py-20 bg-gray-200  bg-cover bg-fixed overflow-y-auto  bg-gradient-to-tr from-gray-600 via-gray-400 to-cyan-800  ">
      <div className="container max-w-6xl mx-auto">
        <div className="grid grid-cols-4 gap-8 mt-10 sm:grid-cols-8 lg:grid-cols-8 sm:px-8 xl:px-0">
          <div className="relative flex flex-col items-center justify-between col-span-4 px-8 py-12 hover:bg-gray-200  space-y-4 overflow-hidden bg-gray-100 sm:rounded-xl">
          ...
          <div className="flex flex-col  items-center justify-between col-span-4 px-8  py-12 space-y-4 bg-gray-100 sm:rounded-xl hover:bg-gray-200">
            ...
            <h4 className="text-xl font-medium text-gray-700">Tecnología NFC</h4>
            <p className="text-base text-center text-gray-500">
          ...
          <div className="flex flex-col items-center justify-between col-span-4 hover:bg-gray-200 px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl">
            <div className="p-3 text-white bg-blue-500 rounded-full">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-8 h-8 "
          ...
          <div className="flex flex-col items-center justify-between col-span-4 hover:bg-gray-200 px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl">
            ...
            <h4 className="text-xl font-medium text-gray-700">Compatibilidad</h4>
            <p className="text-base text-center text-gray-500">
